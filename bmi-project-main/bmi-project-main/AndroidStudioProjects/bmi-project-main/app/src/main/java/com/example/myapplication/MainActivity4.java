...
public class MainActivity4 extends AppCompatActivity {
    ...
    FirebaseFirestore f;
    Button b2_kginc, bu_kgdec;
    Button b2_cminc, bu_cmdec;
    Button save_data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bu_kgdec = findViewById(R.id.b_kgdec);
        b2_kginc = findViewById(R.id.b2_kginc);
        bu_cmdec = findViewById(R.id.bu_cmdec);
        ...
        bu_kgdec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                kg = kg - 1;
                tv_kg.setText(kg + "");
        ...
        bu_cmdec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cm = cm - 1;
                tv_cm.setText(cm + "");
